package com.kukis.horoscoapp.ui.providers

import com.kukis.horoscoapp.R
import com.kukis.horoscoapp.ui.model.LuckyModel
...
class RandomCardProvider @Inject constructor() {
    fun getLucky(): LuckyModel? {
        return when(Random.nextInt(0, 32)) {
            ...
            else -> LuckyModel(R.drawable.card_king_pentacles, R.string.luck_31)
        }
    }
}